...
const SignUp = ({ signUpUser, getAvatars }) => {
      ...
      signUpUser({ ...newUser, doc: newUser.doc }).then((res) => {
        ...
        if (!res.success) {
          ...
          typeof res.res === "string"
            ? setErrors([{ message: "Ups! intentelo más tarde." }])
            : setErrors(res.res);
        }
      });
    } else setErrors([{ message: "Todos los campos deben estar completos." }]);
  };
  ...
  return (
    <>
      ...
      >
        {" "}
        {mensaje1 ? mensaje1 : mensaje4 && mensaje4}{" "}
      </ReactTooltip>
      <ReactTooltip
        id="buttonError4"
        place="top"
      ...
      <div className="container">
        <div className="grayContainer">
          ...
          <div className="inputs">
              ...
              />
              {
                <img
                  ...
                  style={{
                    ...
                    width: "30px",
                    display:
                      (error.errorOne && !newUser.name.length) || error.errorTwo
                        ? "block"
                        : "none",
                  }}
            ...
            <div className="forError">
              <input
                ...
                name="validPassword"
                className={
                  error.errorOne && !newUser.validPassword.length
                    ? "errorY"
                    : "errorN"
                }
                onChange={addUserHandler}
          ...
          <h3>Elegí tu avatar para perfil</h3>
            ...
            </div>
            {
              <img
                ...
                style={{
                  height: "30px",
                  width: "30px",
                  display: error.errorOne && errors.length ? "block" : "none",
                }}
                src="/assets/cross.png"
                alt="..."
              />
